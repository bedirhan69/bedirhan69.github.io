...
<body onload="myFunction()" style="margin:0;">
    ...
    <form action="" method="POST" name="forum1">
        <div class="group">
            <input type="text" name="adsoyad"><span class=" highlight " value="adsoyad"></span><span class="bar "></span>
            <label>Ad-Soyad</label>
        </div>
        <div class="group ">
            <input type="text " name="kadi"><span class=" highlight " value="kadi"></span><span class="bar "></span>
            <label>Kullanıcı Adı</label>
        </div>
        <div class="group ">
            <input type="password " name="sifre"><span class=" highlight " value="sifre"></span><span class="bar "></span>
            <label>Şifre</label>
        </div>
        <div class="group ">
            <input type="password " name="sifret"><span class=" highlight " value="sifret"></span><span class="bar "></span>
            <label>Şifre Tekrar</label>
        </div>
        <div class="group ">
            <input type="text " name="eposta"><span class=" highlight " value="eposta"></span><span class="bar "></span>
            <label>E-Posta</label>
        </div>
        <button type="submit " class="button buttonBlue " name="kayit" value="kayit" onclick=kayıt()>Kayıt Ol
